...
# got10k
config.FREEMASK.DATASET.YTBVOS.PATH = '/data/segmentation/Crop/YTBVOS/crop511'
config.FREEMASK.DATASET.YTBVOS.ANNOTATION = '/data/segmentation/Crop/YTBVOS/train.json'
config.FREEMASK.DATASET.YTBVOS.RANGE = 20
config.FREEMASK.DATASET.YTBVOS.USE = 100000

# visdrone
config.FREEMASK.DATASET.COCO.ANNOTATION = '/data/segmentation/Crop/coco/train2017.json'
config.FREEMASK.DATASET.COCO.PATH = '/data/segmentation/Crop/coco/crop511'
config.FREEMASK.DATASET.COCO.RANGE = 1
config.FREEMASK.DATASET.COCO.USE = 100000

# train
config.FREEMASK.TRAIN.MODEL = "OceanPlus"
